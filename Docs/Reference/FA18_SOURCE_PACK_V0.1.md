...
1. **CR-3608 Appendix** — **IN PROGRESS**. A2–A6 (`F-18 Body`, beta=0) extracted as 228 rows and A7–A12 (`F-18 Body`, beta=10) extracted as 174 unique rows. Current total: **402 rows**. Next block: A13–A17 (`F-18 Body, Wing`, beta=0).
